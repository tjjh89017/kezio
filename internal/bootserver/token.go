...
// agent registration endpoint) hashes it exactly the same way this
// package minted it, instead of re-implementing the same handful of
// lines and risking the two drifting apart.
func HashToken(token string) string {
