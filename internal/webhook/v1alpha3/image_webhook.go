...
func SetupImageWebhookWithManager(mgr ctrl.Manager) error {
	return ctrl.NewWebhookManagedBy(mgr).For(&keziov1alpha3.Image{}).
...
// +kubebuilder:webhook:path=/validate-kezio-kojuro-date-v1alpha3-image,mutating=false,failurePolicy=fail,sideEffects=None,groups=kezio.kojuro.date,resources=images,verbs=create;update,versions=v1alpha3,name=vimage-v1alpha3.kb.io,admissionReviewVersions=v1
...
func (v *ImageCustomValidator) ValidateUpdate(ctx context.Context, oldObj, newObj runtime.Object) (admission.Warnings, error) {
	image, ok := newObj.(*keziov1alpha3.Image)
	if !ok {
...
func (v *ImageCustomValidator) validateImage(ctx context.Context, image *keziov1alpha3.Image) (admission.Warnings, error) {
...
func (v *ImageCustomValidator) validateSlotContentSizes(ctx context.Context, image *keziov1alpha3.Image) (admission.Warnings, error) {
	...
	for _, slot := range image.Spec.Layout.Slots {
		...
		content := &keziov1alpha3.PartitionContent{}
...
// it.
func (v *ImageCustomValidator) validatePostHookRefs(ctx context.Context, image *keziov1alpha3.Image) (admission.Warnings, error) {
	var warnings admission.Warnings
