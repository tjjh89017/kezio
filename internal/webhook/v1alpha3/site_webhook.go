...
func SetupSiteWebhookWithManager(mgr ctrl.Manager) error {
	return ctrl.NewWebhookManagedBy(mgr).For(&keziov1alpha3.Site{}).
...
// +kubebuilder:webhook:path=/validate-kezio-kojuro-date-v1alpha3-site,mutating=false,failurePolicy=fail,sideEffects=None,groups=kezio.kojuro.date,resources=sites,verbs=create;update,versions=v1alpha3,name=vsite-v1alpha3.kb.io,admissionReviewVersions=v1
...
func (v *SiteCustomValidator) ValidateUpdate(ctx context.Context, _, newObj runtime.Object) (admission.Warnings, error) {
	site, ok := newObj.(*keziov1alpha3.Site)
	if !ok {
...
func (v *SiteCustomValidator) validateSite(ctx context.Context, site *keziov1alpha3.Site) error {
...
func (v *SiteCustomValidator) validateSeederSubnetRef(ctx context.Context, site *keziov1alpha3.Site) error {
...
// network probe.
func validateTrackerExternalURL(site *keziov1alpha3.Site) error {
...
func validateTrackerMatchesSeeding(site *keziov1alpha3.Site) error {
