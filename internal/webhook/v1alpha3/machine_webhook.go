...
func SetupMachineWebhookWithManager(mgr ctrl.Manager) error {
	return ctrl.NewWebhookManagedBy(mgr).For(&keziov1alpha3.Machine{}).
...
// +kubebuilder:webhook:path=/validate-kezio-kojuro-date-v1alpha3-machine,mutating=false,failurePolicy=fail,sideEffects=None,groups=kezio.kojuro.date,resources=machines,verbs=create;update,versions=v1alpha3,name=vmachine-v1alpha3.kb.io,admissionReviewVersions=v1
...
func (v *MachineCustomValidator) ValidateUpdate(ctx context.Context, oldObj, newObj runtime.Object) (admission.Warnings, error) {
	machine, ok := newObj.(*keziov1alpha3.Machine)
	if !ok {
...
func (v *MachineCustomValidator) validateMachine(ctx context.Context, machine *keziov1alpha3.Machine) error {
...
func (v *MachineCustomValidator) validateSubnetRef(ctx context.Context, machine *keziov1alpha3.Machine) error {
...
func validateMachineBMC(machine *keziov1alpha3.Machine) error {
...
func validateBMCInsecureSkipVerify(machine *keziov1alpha3.Machine) error {
	value, ok := machine.Annotations[keziov1alpha3.MachineAnnotationBMCInsecureSkipVerify]
	if !ok {
		return nil
	}
	if value != "true" && value != "false" {
		return fmt.Errorf("annotation %q has value %q, expected exactly \"true\" or \"false\"",
			keziov1alpha3.MachineAnnotationBMCInsecureSkipVerify, value)
	}
	return nil
}
...
func validateInspectDisable(machine *keziov1alpha3.Machine) error {
	value, ok := machine.Annotations[keziov1alpha3.MachineAnnotationInspectDisable]
	if !ok {
		return nil
	}
	if value != "true" {
		return fmt.Errorf("annotation %q has value %q, expected exactly \"true\"", keziov1alpha3.MachineAnnotationInspectDisable, value)
	}
	if machine.Spec.BootMACAddress == "" {
		return fmt.Errorf("spec.bootMACAddress is required when annotation %q is \"true\"", keziov1alpha3.MachineAnnotationInspectDisable)
	}
	return nil
}
