...
func SetupMachineHardwareWebhookWithManager(mgr ctrl.Manager) error {
	return ctrl.NewWebhookManagedBy(mgr).For(&keziov1alpha2.MachineHardware{}).
...
// +kubebuilder:webhook:path=/validate-kezio-kojuro-date-v1alpha2-machinehardware,mutating=false,failurePolicy=fail,sideEffects=None,groups=kezio.kojuro.date,resources=machinehardwares,verbs=create;update,versions=v1alpha2,name=vmachinehardware-v1alpha2.kb.io,admissionReviewVersions=v1
...
func (v *MachineHardwareCustomValidator) ValidateCreate(_ context.Context, obj runtime.Object) (admission.Warnings, error) {
	machinehardware, ok := obj.(*keziov1alpha2.MachineHardware)
	if !ok {
...
func (v *MachineHardwareCustomValidator) ValidateUpdate(_ context.Context, oldObj, newObj runtime.Object) (admission.Warnings, error) {
	machinehardware, ok := newObj.(*keziov1alpha2.MachineHardware)
	if !ok {
