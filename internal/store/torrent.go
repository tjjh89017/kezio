...
// BitTorrent v1 bencoded info dict.
...
// ParseInfoHash parses s, the lowercase-hex form InfoHash.String() and
// Image.status.partitions[].infoHash both use, back into an InfoHash. It
// is the inverse of String and is what callers holding only a status
// string (a caller resolving a content directory to seed, for example)
// need to reach store paths keyed by InfoHash.
