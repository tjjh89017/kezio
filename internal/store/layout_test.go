...
// NestExtentFiles has run, i.e. what a real publish step leaves behind
// inside a content's PVC. Each extent file is filled with arbitrary bytes
// of the right length. It returns the directory path.
