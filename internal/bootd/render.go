...
// GRUB's network file syntax (bootserver.GrubNetPath - GRUB cannot open
// bare URLs), so an unfetchable bootConfigURL is an error here rather
// than a silent boot-time dead end.
