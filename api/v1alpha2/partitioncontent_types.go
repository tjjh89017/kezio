...
// PartitionContentSpec defines the desired state of PartitionContent.
type PartitionContentSpec struct {
	// INSERT ADDITIONAL SPEC FIELDS - desired state of cluster
	// Important: Run "make" to regenerate code after modifying this file

	// Foo is an example field of PartitionContent. Edit partitioncontent_types.go to remove/update
...
// PartitionContent is the Schema for the partitioncontents API.
